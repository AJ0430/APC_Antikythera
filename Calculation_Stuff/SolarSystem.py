...
def daylightSavings(year, month, day, hour=12, minute=30):
...
def moon(year, month, day, hour=12, minute=30):
    mooninfo = ss.Moon(year, month, day, hour, minute, -5, daylightSavings(year,month,day,hour,minute), -71.0571, 42.3611, True)
...
def planets(year,month,day,hour=12, minute=30):
...
def JMoons(year, month, day, hour=12, minute=30):
